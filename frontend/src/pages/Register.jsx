      ...
      <div className="w-full max-w-md bg-[var(--card-bg)] border border-[var(--border-main)] p-8 rounded-2xl shadow-sm backdrop-blur-sm transition-all hover:border-emerald-500/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[var(--input-bg)] border border-[var(--input-border)] rounded-lg py-2 px-3 text-[var(--text-main)] placeholder-slate-405 focus:outline-none focus:border-emerald-500 transition-colors"
                placeholder="Doe"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[var(--input-bg)] border border-[var(--input-border)] rounded-lg py-2 pl-3 pr-10 text-[var(--text-main)] placeholder-slate-400 focus:outline-none focus:border-emerald-500 transition-colors"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg py-2.5 text-sm font-bold transition-all disabled:opacity-50 shadow-lg shadow-emerald-500/10 hover:shadow-emerald-500/20 mt-2"
          >
